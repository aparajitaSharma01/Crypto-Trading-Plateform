...
import com.cryptotrading.response.FunctionResponse;
...
public class ChatBotServiceImpl implements ChatBotService {
    ...
    public FunctionResponse getFunctionResponse(String prompt) {
        ...
        try {
            ...
            System.out.println("No function call found in response or error parsing: " + e.getMessage());
            // Return a safe default or null to indicate no function call
            FunctionResponse res = new FunctionResponse();
            res.setCurrencyName("bitcoin"); // Default fallback
            res.setCurrencyData("");
